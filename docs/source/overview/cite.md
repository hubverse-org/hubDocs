...
Citation for _the hubverse_ should look like the example below. Be sure to update the release number and date. To find the most current release number and date, go to the [hubverse documentation page](https://github.com/Infectious-Disease-Modeling-Hubs/hubDocs) and look for the information in the middle of the right hand column under **Releases**.
